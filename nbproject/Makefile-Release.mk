...
${TESTDIR}/tests/ControllerTest.o: tests/ControllerTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ControllerTest.o tests/ControllerTest.cpp


${TESTDIR}/tests/ControllerTestRunner.o: tests/ControllerTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ControllerTestRunner.o tests/ControllerTestRunner.cpp
...
${OBJECTDIR}/Controller_nomain.o: ${OBJECTDIR}/Controller.o Controller.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Controller_nomain.o Controller.cpp;\
	else  \
